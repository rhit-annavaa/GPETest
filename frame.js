...
document.getElementById('container1').appendChild(renderer3.domElement);
document.getElementById('container2').appendChild(renderer1.domElement);
...
loader1.load( 'public/gpe_testframe/scene.gltf', function ( gltf ) {
  //for car model
...
//   [scene, scene1, scene2, scene3].forEach(s => {
//       while (s.children.length > 0) {
//           s.remove(s.children[0]);
//       }
//   });

//   // Load the model based on the modelName parameter
//   let path;
//   switch (modelName) {
//       case 'frame':
//           path = 'public/gpe_testframe/scene.gltf';
//           // loader3.load(path, (gltf) => scene3.add(gltf.scene));
//           loader3.load(path, (gltf) => {
//             scene3.add(gltf.scene);
//         }, undefined, (error) => {
...
//           break;
//       case 'engine':
//           path = 'public/gpe_testengine/scene.gltf';
//           // loader2.load(path, (gltf) => scene2.add(gltf.scene));
//           loader2.load(path, (gltf) => {
//             scene2.add(gltf.scene);
//         }, undefined, (error) => {
//             console.error("Error loading model:", error);
//         });
...
//           break;
//       case 'drivetrain':
//           path = 'public/gpe_testdrivetrain/scene.gltf';
//           // loader.load(path, (gltf) => scene.add(gltf.scene));
...
//           break;
//       case 'car':
//           path = 'public/gpe_testone/scene.gltf';
//           // loader1.load(path, (gltf) => scene1.add(gltf.scene));
//           loader.load(path, (gltf) => {
//             scene.add(gltf.scene);
//         }, undefined, (error) => {
//             console.error("Error loading model:", error);
...
document.addEventListener("DOMContentLoaded", () => {
  document.getElementById("frameButton").addEventListener("click", () => loadModel('frame'));
  document.getElementById("engineButton").addEventListener("click", () => loadModel('engine'));
  document.getElementById("drivetrainButton").addEventListener("click", () => loadModel('drivetrain'));
  document.getElementById("carButton").addEventListener("click", () => loadModel('car'));
});
